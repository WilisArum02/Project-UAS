...
try {
    ...
    // Building the JPA query dynamically based on the selected criteria
    String queryString = "SELECT b.isbn, b.judul, b.pengarang, b.penerbit, b.tahun, b.jumlahHalaman, k.nama as kategori "
            + "FROM Buku_1 b JOIN b.idKategori k WHERE ";
    ...
    switch (jComboBoxPencarian.getSelectedIndex()) {
        ...
        case 1:
            ...
            break;
        case 2:
            queryString += "LOWER(k.nama) LIKE LOWER(:searchTerm)";
            break;
        case 3:
            queryString += "LOWER(b.pengarang) LIKE LOWER(:searchTerm)";
            break;
